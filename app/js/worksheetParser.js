module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c13 = function(json) { return JSON.parse("{"+json.join("")+"}"); },
        peg$c14 = ";; gorilla-repl.fileformat = 1",
        peg$c15 = { type: "literal", value: ";; gorilla-repl.fileformat = 1", description: "\";; gorilla-repl.fileformat = 1\"" },
        peg$c16 = null,
        peg$c17 = function(meta, content) {return segment.freeSegment(utils.unmakeClojureComment(content), meta);},
        peg$c18 = ";; **",
        peg$c19 = { type: "literal", value: ";; **", description: "\";; **\"" },
        peg$c20 = function(content, cs, out) {return segment.codeSegment(content, utils.unmakeClojureComment(cs), utils.unmakeClojureComment(out));},
        peg$c21 = ";; @@",
        peg$c22 = { type: "literal", value: ";; @@", description: "\";; @@\"" },
        peg$c23 = function(output) {return output;},
        peg$c24 = ";; =>",
    ...
    function peg$parsefreeSegment() {
      ...
      if (s1 !== peg$FAILED) {
        ...
        if (s2 !== peg$FAILED) {
          s3 = peg$parsestringNoDelim();
          if (s3 === peg$FAILED) {
            s3 = peg$c16;
          }
          if (s3 !== peg$FAILED) {
            s4 = peg$parsefreeSegmentCloseTag();
            if (s4 !== peg$FAILED) {
              peg$reportedPos = s0;
              s1 = peg$c17(s2, s3);
              s0 = s1;
